...
signal modo_controle_alterado(mobile: bool)
signal partida_resetada
...
func definir_modo_mobile(valor: bool) -> void:

	modo_mobile = valor

	modo_controle_alterado.emit(
		modo_mobile
	)
